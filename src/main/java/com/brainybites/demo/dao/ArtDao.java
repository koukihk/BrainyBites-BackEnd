...
public interface ArtDao {
     ...
     * 22-12-19 创建方法
     * 22-12-23 BUG 修改, SQL 多了一个逗号
     * 22-12-24 方法修改, 替换了排序方式
     * 22-12-28 方法修改, 添加了用户浏览内容去重
     * 23-01-02 修改方法名称, 添加了 New 的后缀
     * @param start
     * @param pageSize
     * @return
     */
     ...
     * 22-12-19 创建方法
     * 22-12-23 BUG 修改, SQL 多了一个逗号; 参数 type 修改为 artType
     * 22-12-24 方法修改, 替换了排序方式
     * 22-12-28 方法修改, 添加了用户浏览内容去重
     * 23-01-02 修改方法名称, 添加了 New 的后缀
     * @param artType
     ...
     * 简单的搜索功能
     * 22-12-20 创建方法
     * 22-12-23 BUG 修改, SQL 多了一个逗号; 删除了 SQL 中不必要的字段.
     * 22-12-24 方法修改, 替换了排序方式
     * @param key
     * @param start
     * @param pageSize
